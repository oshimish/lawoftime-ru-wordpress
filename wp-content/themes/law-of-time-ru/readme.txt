...
Tags: blog, custom-menu, featured-images, threaded-comments, translation-ready, left-sidebar, custom-background, e-commerce, theme-options, sticky-post, full-width-template
Requires at least: 4.0
Tested up to: 4.7

Copyright (c) 2020 by oshimish (oshimish@gmail.com)
...
Тема для русскоязычного сайта синхронизации 13:20 

Page templates
* Left-Sidebar (default page template)
* Right-Sidebar 
* Full-Width
...
* Based on WP Bootstrap Starter http://afterimagedesigns.com/, (c) 2016 by Afterimage Designs, [GPLv2 or later](https://www.gnu.org/licenses/gpl-2.0.html)
